...
import { ACCIDENTAL, DisplayOption, Instrument, KEYBOARD, BaseNote, KeySignature, Mode, Pitch, Scale} from '../types/types'
...
export function DrawNotes(props: DrawNotesProps) {
    const { scale, mode, instrument, pitch, keySignature, displayOption, width, height } = props;
    ...
    useEffect(() => {
        ...
        if (div) {
            ...
            let notes: StaveNote[] = getInstrumentNotes();
