...
import { DisplayOption, DISPLAYOPTIONS, Instrument, INSTRUMENTS, KeySignature, KEYSIGNATURES, Mode, MODES, Pitch, PITCHES, Scale, SCALES } from '../types/types'
import { HEADER, SPACING } from './config-layout';
import { DrawNotes } from '../middleware/drawnotes';
...
export default function Body(props: BodyProps) {
    ...
    useEffect(() => {
        ...
        UpdateStatus(INSTRUMENTS[0], SCALES[0], MODES[0], PITCHES[0], KEYSIGNATURES[0], DISPLAYOPTIONS[0]);
    }, [props.setMessage, props.setStatus])

    function UpdateStatus(inst: Instrument | undefined, scal: Scale | undefined, mod: Mode | undefined, pitc: Pitch | undefined, key: KeySignature | undefined, display: DisplayOption | undefined) {
    ...
    function HandleInstrumentChange(event: React.ChangeEvent<HTMLSelectElement>): void {
        ...
        const inst: Instrument | undefined = INSTRUMENTS.find((i) => i.name == instName);
        if (inst !== undefined) {
            setInstrument(inst);
            ...
            <Grid container direction='column'>
                <Grid container direction='row'>
                    <Grid item>
                        ...
                        <select
                            id='instrument'
                            value={instrument != undefined ? instrument.name : INSTRUMENTS[0].name}
                ...
                <Grid container direction='row' justifyContent='flex-left'>
                    <Grid item sm={'auto'}>
